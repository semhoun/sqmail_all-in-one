...
$config['plugins'] = ['additional_message_headers', 'archive', 'attachment_reminder', 'autologon', 'emoticons', 'gravatar', 'help', 'identity_select', 'jqueryui', 'managesieve', 'markasjunk', 'newmail_notifier', 'password', 'thunderbird_labels', 'vcard_attachments', 'zipdownload'];
